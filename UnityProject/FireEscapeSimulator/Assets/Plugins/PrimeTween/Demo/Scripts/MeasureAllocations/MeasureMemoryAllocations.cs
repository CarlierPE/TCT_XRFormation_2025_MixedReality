...
#pragma warning disable 0414
        ...
        [SerializeField] List<string> filterAllocations = new();
        [SerializeField] List<string> ignoreAllocations = new();
#pragma warning restore 0414
#if UNITY_EDITOR && UNITY_2019_1_OR_NEWER
        public int? gcAllocTotal { get; private set; }
        readonly Stack<int> stack = new();
        readonly List<int> childrenBuffer = new();
        readonly List<int> fullIdPathBuffer = new();
        readonly List<int[]> ignoredPaths = new();
        readonly List<int[]> filteredPaths = new();
